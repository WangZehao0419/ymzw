  ...
  <div class="app-container">
    <el-form ref="queryForm" :model="queryParams" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="车间编号" prop="workshopNo">
        <el-input v-model="queryParams.workshopNo" placeholder="请输入车间编号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="workshopList">
      ...
      <el-table-column label="车间编号" prop="workshopNo" min-width="120" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="560px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="90px">
        <el-form-item label="车间编号" prop="workshopNo"><el-input v-model="form.workshopNo" placeholder="请输入车间编号" /></el-form-item>
        ...
        <el-form-item label="负责人" prop="workshopManager"><el-input v-model="form.workshopManager" placeholder="请输入负责人" /></el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: { pageNum: 1, pageSize: 10, workshopNo: '', workshopName: '', workshopStatus: '' },
      form: {},
      rules: {
        workshopNo: [{ required: true, message: '车间编号不能为空', trigger: 'blur' }],
  ...
  methods: {
    ...
    reset() { this.form = { id: undefined, workshopNo: '', workshopName: '', workshopLocation: '', workshopManager: '', workshopStatus: '0', workshopRemark: '' }; this.resetForm('form') },
    handleQuery() { this.queryParams.pageNum = 1; this.getList() },
    resetQuery() { this.resetForm('queryForm'); this.handleQuery() },
    handleAdd() { this.reset(); this.title = '新增车间'; this.open = true },
    handleUpdate(row) { this.reset(); getWorkshop(row.id).then(data => { this.form = { ...data }; this.title = '编辑车间'; this.open = true }) },
